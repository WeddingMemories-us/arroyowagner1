...
class GuestbooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guestbook" do
    assert_difference('Guestbook.count') do
      post guestbooks_url, params: { guestbook: { message: @guestbook.message, user_id: @guestbook.user_id } }
    end
  ...
  test "should update guestbook" do
    patch guestbook_url(@guestbook), params: { guestbook: { message: @guestbook.message, user_id: @guestbook.user_id } }
